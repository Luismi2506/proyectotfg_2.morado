...
<div class="app" id="app">
  ...
  <div class="sub">Plan mensual</div>
    ...
    <button class="nav-item" onclick="goTo('ingresos',this)">
      <svg class="icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="8" cy="8" r="6.5"/><path d="M8 5v6M5.5 7.5L8 5l2.5 2.5"/></svg>
      Ingresos
    </button>
    <button class="nav-item" onclick="goTo('gastos',this)">
      <svg class="icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="8" cy="8" r="6.5"/><path d="M8 11V5M5.5 8.5L8 11l2.5-2.5"/></svg>
      Gastos fijos
    </button>
    ...
    <button class="nav-item" onclick="goTo('presupuesto',this)">
      <svg class="icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="1.5" y="2" width="13" height="12" rx="2"/><path d="M5 6h6M5 9h4"/></svg>
      Presupuesto
    </button>
    <button class="nav-item" onclick="goTo('objetivos',this)">
      <svg class="icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="8" cy="8" r="6.5"/><circle cx="8" cy="8" r="3"/><circle cx="8" cy="8" r=".5" fill="currentColor"/></svg>
      Objetivos
    </button>
    ...
    <div class="content" style="position:relative">
      ...
      <div class="screen active" id="screen-dashboard">
        ...
        <div class="two-col">
          ...
          <div class="card">
            <div class="card-header"><span class="card-title">Últimos movimientos</span><button class="btn" onclick="goToNav('movimientos')">Ver todos</button></div>
            <div id="dash-movimientos"></div>
          </div>
        </div>
        <div class="card">
          <div class="card-header"><span class="card-title">Progreso de objetivos</span><button class="btn" onclick="goToNav('objetivos')">Gestionar</button></div>
...
<div class="screen" id="screen-perfil">
  <div class="perfil-wrapper">
    <div class="card perfil-card">
      ...
      <div id="modal-container" style="display:none;position:absolute;inset:0;background:rgba(0,0,0,.3);display:none;align-items:center;justify-content:center;z-index:200;min-height:500px">
